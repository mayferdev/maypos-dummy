...
if(!class_exists('OP_Receipt'))
{
    class OP_Receipt{
        ...
        public function get_template_preview_data($template){
            ...
            if(isset($template['type']) && $template['type'] == 'zreport')
            {
            ...
            if($login_cashdrawer_id)
            {
                ...
                if(!is_array($gift_receipt))
                {
                    ...
                    if($gift_receipt && !empty($gift_receipt))
                    {
                        ...
                        $session_response_data['setting']['receipt_gift_full_template'] = $this->generate_full_receipt_template($gift_receipt);
                    }
                }
                ...
                if($current_zreport && !empty($current_zreport))
                {
                    ...
                    $session_response_data['pos_report_template']= $this->generate_full_receipt_template($current_zreport);
                }
            }
