...
class OP_Woo{
    ...
    public function formatWooOrder($order_id){
        ...
        if($allow_laybuy == 'yes')
        {
            $transactions = $this->getOrderTransactions($order_number,array( 'order'));
        ...
        <table width="100%" class="order-transactions-table">
            ...
            <tr>
                ...
                <td>
                    ...
                    <p><i><?php echo __('via','openpos'); ?></i>&nbsp;<b><?php echo $transaction['payment_name']; ?></b></p>
                </td>
    ...
    public function getNoficications($from_time = 0){
